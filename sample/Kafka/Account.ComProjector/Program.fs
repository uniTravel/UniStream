...
module Program =
    ...
    let main args =
        ...
        builder.Services.AddKeyedSingleton<IWorker, ComProjector<Account>>(typeof<Account>)
        |> ignore

        builder.Services.AddKeyedSingleton<IWorker, ComProjector<Transaction>>(typeof<Transaction>)
        |> ignore
