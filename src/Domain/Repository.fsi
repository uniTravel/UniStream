...
module Repository =
    ...
    val fromCache : T<'agg> -> Guid -> AsyncReplyChannel<Result<'agg * int64, string>> -> T<'agg>
    ...
    /// <param name="channel">返回聚合的通道。</param>
    val inline fromStore : T< ^agg> -> Guid -> ^agg -> int64 -> AsyncReplyChannel<Result< ^agg * int64, string>> -> T< ^agg>
        when ^agg : (member ApplyEvent : (string -> byte[] -> ^agg))
    ...
    /// <param name="aggId">聚合ID。</param>
    /// <param name="channel">返回聚合的通道。</param>
    val inline cTake : T< ^agg> -> Guid -> AsyncReplyChannel<Result< ^agg * int64, string>> -> T< ^agg>
    ...
    /// <param name="version">聚合版本。</param>
    val cPut : T<'agg> -> Guid -> 'agg -> int64 -> T<'agg>
    ...
    /// <param name="aggId">聚合ID。</param>
    /// <param name="channel">返回聚合的通道。</param>
    val inline sTake : T< ^agg> -> Guid -> AsyncReplyChannel<Result< ^agg * int64, string>> -> T< ^agg>
        when ^agg : (static member Initial : ^agg)
        and ^agg : (member ApplyEvent : (string -> byte[] -> ^agg))
    ...
    /// <param name="agg">要放回的聚合。</param>
    /// <param name="version">聚合版本。</param>
    val sPut : int64 -> T<'agg> -> Guid -> 'agg -> int64 -> T<'agg>